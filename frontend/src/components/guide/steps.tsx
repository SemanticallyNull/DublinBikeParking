...
const IllustrationCheckStand = () => (
  <svg id="a" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 980.78 820.3"><path d="M111.36,800.8v-361.77c0-46.44,37.65-84.09,84.09-84.09h274.06c46.44,0,84.09,37.65,84.09,84.09v361.77" fill="none" stroke="#fff" stroke-linecap="round" stroke-miterlimit="10" stroke-width="39"/><line x1="19.5" y1="800.8" x2="776.54" y2="800.8" fill="#fff" stroke="#5a94c8" stroke-linecap="round" stroke-miterlimit="10" stroke-width="39"/><path d="M779.88,158.93c.29,77.89-63.93,141.76-141.44,141.44-78.11,0-141.44-63.32-141.44-141.44,3.18-185.91,279.72-185.91,282.88,0Z" fill="#fff" stroke="#5a94c8" stroke-linecap="round" stroke-miterlimit="10" stroke-width="39"/><line x1="740.62" y1="270.62" x2="790.76" y2="319.12" fill="#fff" stroke="#5a94c8" stroke-linecap="round" stroke-miterlimit="10" stroke-width="39"/><line x1="790.76" y1="319.12" x2="938.78" y2="462.31" fill="#fff" stroke="#5a94c8" stroke-linecap="round" stroke-miterlimit="10" stroke-width="84"/></svg>
)

const IllustrationChooseLock = () => (
  <svg id="a" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 902.49 924.6"><rect x=".5" y="519.31" width="476.47" height="129.63" rx="43.51" ry="43.51" fill="#fff" stroke="#000" stroke-miterlimit="10"/><path d="M397.78,558.42c-12.7,0-23-10.3-23-23v-231.04c0-75.01-61.03-136.04-136.04-136.04s-136.04,61.03-136.04,136.04v231.04c0,12.7-10.3,23-23,23s-23-10.3-23-23v-231.04c0-100.38,81.66-182.04,182.04-182.04s182.04,81.66,182.04,182.04v231.04c0,12.7-10.3,23-23,23Z" fill="#fff" stroke="#0e2052" stroke-miterlimit="10" stroke-width="6"/><path d="M793.81,137.34c21.46,21.46,46.71,54.22,48.53,95.62,2.36,53.63-36.94,69.15-34.53,124.31,2.26,51.87,38.13,63.2,42.93,122.23,2.89,35.6-7.39,65.5-15.87,84.32" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="18"/><path d="M791.18,137.34c-53.84-14.74-60.84-66.68-43.01-73.13,36.27-13.11,43.01,37.5,43.01,73.13" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="18"/><path d="M834.96,563.82c21.88,51.36-14.49,89.09-30.62,79.11-32.79-20.29,2.69-56.99,30.62-79.11" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="18"/><line x1="599.8" x2="599.8" y2="751.66" fill="#fff" stroke="#5a94c8" stroke-miterlimit="10" stroke-width="6"/><circle cx="238.74" cy="835.85" r="88.75" fill="#009245"/><polyline points="286.44 786.83 212.72 884.88 191.03 848.16" fill="none" stroke="#fff" stroke-miterlimit="10" stroke-width="16"/><circle cx="813.74" cy="835.85" r="88.75" fill="#772018"/><line x1="782.48" y1="800.93" x2="852.33" y2="870.78" fill="none" stroke="#fff" stroke-miterlimit="10" stroke-width="10"/><line x1="778.81" y1="870.78" x2="848.67" y2="800.93" fill="none" stroke="#fff" stroke-miterlimit="10" stroke-width="10"/></svg>
)
...
export const GUIDE_STEPS: GuideStep[] = [
  ...
  {
    title: 'Fill the lock',
    body: 'Leave as little space as possible inside your D-lock. A tight fit makes it much harder to lever open.',
    illustration: IllustrationLockFrame,
  },
  {
