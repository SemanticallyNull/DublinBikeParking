<template>
  <div class="container">
    ...
    <p>DublinBikeParking ("us", "we", or "our") operates the https://www.dublinbikeparking.com/
    ...
    <p>We use your data to provide and improve the Service. By using the Service, you agree to the
      ...
      Terms and Conditions, accessible from https://www.dublinbikeparking.com/</p>

    <h2>Definitions</h2>
    <ul class="definitions">
      <li>
        <p><strong>Service</strong></p>
        <p>Service is the https://www.dublinbikeparking.com/ website operated by
          DublinBikeParking</p>
      </li>
      <li>
      ...
      <li>
        ...
        <p>For the purpose of this Privacy Policy, we are a Data Controller of your Personal
          Data.</p>
      </li>
      <li>
    ...
    <h2>Use of Data</h2>
    <p>DublinBikeParking uses the collected data for various purposes:</p>
    <ul>
      ...
      <li>To provide you with news, special offers and general information about other goods,
        ...
        or enquired about unless you have opted not to receive such information</li></ul>


    <h2>Legal Basis for Processing Personal Data under the General Data Protection Regulation
      (GDPR)</h2>
    <p>If you are from the European Economic Area (EEA), DublinBikeParking legal basis for
      collecting and using the personal information described in this Privacy Policy depends on the
      Personal Data we collect and the specific context in which we collect it.</p>
    <p>DublinBikeParking may process your Personal Data because:</p>
    <ul>
    ...
    <p>DublinBikeParking will retain your Personal Data only for as long as is necessary for the
    ...
    <p>DublinBikeParking will also retain Usage Data for internal analysis purposes. Usage Data is
    ...
    <p>If you are located outside Ireland and choose to provide information to us, please note that
      we transfer the data, including Personal Data, to Ireland and process it there.</p>
    ...
    <p>DublinBikeParking will take all the steps reasonably necessary to ensure that your data is
    ...
    <p>If DublinBikeParking is involved in a merger, acquisition or asset sale, your Personal Data
    ...
    <p>Under certain circumstances, DublinBikeParking may be required to disclose your Personal Data
    ...
    <p>DublinBikeParking may disclose your Personal Data in the good faith belief that such action
      is necessary to:</p>
    <ul>
      <li>To comply with a legal obligation</li>
      <li>To protect and defend the rights or property of DublinBikeParking</li>
    ...
    <p>If you are a resident of the European Economic Area (EEA), you have certain data protection
      rights. DublinBikeParking aims to take reasonable steps to allow you to correct, amend, delete
    ...
    <ul>
      ...
      <li>
        <p><strong>The right of rectification.</strong> You have the right to have your information
          rectified if that information is inaccurate or incomplete.</p>
      </li>
      <li>
        <p><strong>The right to object.</strong> You have the right to object to our processing of
          your Personal Data.</p>
      </li>
      <li>
        <p><strong>The right of restriction.</strong> You have the right to request that we restrict
          the processing of your personal information.</p>
      </li>
      <li>
        <p><strong>The right to data portability.</strong> You have the right to be provided with a
          copy of the information we have on you in a structured, machine-readable and commonly used
          format.</p>
      </li>
      <li>
        <p><strong>The right to withdraw consent.</strong> You also have the right to withdraw your
          consent at any time where DublinBikeParking relied on your consent to process your
    ...
    <p>We may employ third party companies and individuals to facilitate our Service ("Service
      ...
      in analysing how our Service is used.</p>
    ...
    <ul>
      <li>By email: <a href="mailto:hello@katiechapman.ie">hello@katiechapman.ie</a></li>
    </ul>
  </div>
</template>
